...
<Project Type="Project" LVVersion="18008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="gos Message Queue.lvlib" Type="Library" URL="../support/Message Queue/gos Message Queue.lvlib"/>
			<Item Name="gos User Event - Stop.lvlib" Type="Library" URL="../support/User Event - Stop/gos User Event - Stop.lvlib"/>
			<Item Name="gos Set Enable State on Multiple Controls.vi" Type="VI" URL="../support/gos Set Enable State on Multiple Controls.vi"/>
			<Item Name="gos Check Loop Error.vi" Type="VI" URL="../support/gos Check Loop Error.vi"/>
			<Item Name="gos Error Handler - Event Handling Loop.vi" Type="VI" URL="../support/gos Error Handler - Event Handling Loop.vi"/>
			<Item Name="gos Error Handler - Message Handling Loop.vi" Type="VI" URL="../support/gos Error Handler - Message Handling Loop.vi"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="gos Acquired Data.ctl" Type="VI" URL="../controls/gos Acquired Data.ctl"/>
			<Item Name="gos UI Data.ctl" Type="VI" URL="../controls/gos UI Data.ctl"/>
			<Item Name="gos UI State.ctl" Type="VI" URL="../controls/gos UI State.ctl"/>
		</Item>
		<Item Name="gos Acquisition.lvlib" Type="Library" URL="../Acquisition/gos Acquisition.lvlib"/>
		<Item Name="gos Logging.lvlib" Type="Library" URL="../Logging/gos Logging.lvlib"/>
		<Item Name="gos Settings.lvlib" Type="Library" URL="../Settings/gos Settings.lvlib"/>
		<Item Name="gos Main.vi" Type="VI" URL="../gos Main.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Continuous Measurement and Logging Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/gos Main.vi</Property>
