...
<Library LVVersion="18008000">
	...
	<Item Name="Modbus.xctl" Type="XControl" URL="../Modbus.xctl"/>
	<Item Name="Sensor.xctl" Type="XControl" URL="../Sensor.xctl"/>
	<Item Name="Temperature.vi" Type="VI" URL="../Temperature.vi"/>
	<Item Name="General Status.xctl" Type="XControl" URL="../General Status.xctl"/>
	<Item Name="Loop Control.xctl" Type="XControl" URL="../Loop Control.xctl"/>
</Library>
